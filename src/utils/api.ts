...
import {CoordsVO} from '../screens/Home/type';
 ...
 */
export const getCityInfo = async (coords: CoordsVO) => {
 ...
 */
export const getThreeDays = async (coords: CoordsVO) => {
  const key = '687e517f06684448a9f4695721414a07';
 ...
 */
export const getIndices = async (coords: CoordsVO, type = 0) => {
  const key = '687e517f06684448a9f4695721414a07';
